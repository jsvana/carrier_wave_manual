...
Open **Settings** (the gear icon in the tab bar) and fill in your profile:
...
Select your license class (Technician, General, or Amateur Extra in the US). This helps with band plan validation - Carrier Wave can warn you if you try to log a contact on a frequency outside your privileges.
...
Your credentials are stored securely in the iOS Keychain, not in the app's database.
